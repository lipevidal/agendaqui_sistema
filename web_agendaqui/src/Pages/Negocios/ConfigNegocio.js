...
import IconeTutorial from '../../imagens/icones/book-alt.png'
import IconeDuvidas from '../../imagens/icones/interrogation.png'
import IconeContato from '../../imagens/icones/comments.png'
    ...
    <ContainerConfigUnidade>
      <App>
        ...
        <div className='center'>
            ...
            <Links>
              <Link to={`/negocio/editar/${nome_negocio}`} className='box'>
                <div className='img'>
                  <img src={IconeEdit}/>
                </div>
                <p>Editar Dados do Negócio</p>
              </Link>

              <Link to={`/negocio/${nome_negocio}/${unidade}/endereco`} className='box'>
                <div className='img'>
                  <img src={IconeTutorial}/>
                </div>
                <p>Tutorial</p>
              </Link>
